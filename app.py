...
CLUSTERS = {
    "sovereign-stage": {
        ...
        "events": [
            ...
            event("Royal Rhythm (Group Dance)", 5, "A group dance competition featuring Western or Eastern (classical, semi-classical, folk) categories.", "INR 1,500", "If there are less than 5 teams only first prize will be awarded", "Kanan (9108089514), Manikya (8861433696)", "Teams of 5-15 members. Duration is 5+1 minutes. Audio track to be submitted 3 days before the event."),
            ...
            event("Street Play", 5, "Dramatics competition performed in open areas using any theme.", "INR 699", "Winners: INR 6,000; Runner Ups: INR 3,000", "Likith Vignesh (9380942252), Inaya Kazi (88849 56030)", "Teams of 8-15 members. Performance time limit is 10+5 minutes. Performances can be in Kannada, Hindi, or English."),
            event("Mime", 4, "A theatrical performance cluster focusing on silent expression through movement.", "INR 599", "Winners: INR 4,000; Runner Ups: INR 2,000", "Lohan S L (9731297485), Sujay Naganur (6364911458)", "Teams of 6-10 members. Performance time is 8-10 minutes. Background music is allowed, but no props are permitted."),
            ...
            event("Instrumental Solo", 3, "Solo musical performance using any instrument.", "INR 250", "Winners: INR 2,500; Runners Up: INR 1,500", "Bala (6383546926), Deepanjan (7004035118)", "Time limit is 3+2 minutes including setup. Participants must bring their own instruments. One accompanist is allowed to play an instrument only."),
    ...
    "kings-council": {
        ...
        "events": [
            event("DiploMaze (MUN)", 5, "Fast-paced Mini Model United Nations simulation focused on high-pressure diplomacy.", "INR 250", "Cash Prize Pool: INR 6,000 (Best Delegate 3000; High Commendation 2000; Special Mention 1000)", "Anish G (8073459615)", "4-5 hour timeframe. Delegates represent countries to resolve a global agenda through negotiations. Includes informal lobbying and twists."),
            event("Warriors Of The Mind (Quiz)", 3, "General knowledge quiz consisting of rounds of questions and trivia.", "INR 250", "Prize Pool: INR 5,500 (1st prize 3000; 2nd prize 2000)", "Saadyant PR (9353459644), Aditya Kahali (9301806057)", "Team size 1-3 members. Electronic items are strictly prohibited. Quizmaster has the final say."),
            ...
            event("Rise To Reign (The Best Manager)", 4, "Management event testing business awareness and crisis management through 4 competitive rounds. Individual participation", "INR 200", "Prize Pool: INR 6,000", "Arshi Anirudh (9148290373), Ishaan Saxena (7490004027)", "Participants must register by the deadline. Case study must be submitted pre-event. Carrying valid college ID is mandatory for offline rounds."),
